...
-   **重要：継続日数は履歴情報で提供される「連続でトレーニングしている日数」の値を必ず使用してください。画像や投稿文から読み取れる日数ではなく、システムで自動管理されている正確な値を優先します。**
...
-   **「連続でトレーニングしている日数」の値を使用して、トレーニングの継続性を評価・応援する（画像や投稿文から読み取った日数は使用しないこと）**
